                        ...
                        child: Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              hintText: 'name.surename@aastustudent.edu.et',
                            ...
                            validator: _model.aastuEmailTextControllerValidator
                                .asValidator(context),
                          ),
                        ),
                      ),
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              if (functions.checkAAASTUEmail(
                                ...
                                if ((_model.apiResultloe?.succeeded ?? true)) {
              ...
              if (!(isWeb
                ...
                FFButtonWidget(
                  onPressed: () async {
                    ...
                    if (_model.aastuEmailTextController.text ==
