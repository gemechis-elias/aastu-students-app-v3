                                        ...
                                        onPressed: () async {
                                          ...
                                          var dailyNegaritRecordReference =
                                              DailyNegaritRecord.collection
                                                  .doc(currentUserUid);
                                          await dailyNegaritRecordReference
                                              .set(createDailyNegaritRecordData(
                                            id: currentUserUid,
                                          ));
                                          _model.dailyNegaritCreated =
                                              DailyNegaritRecord.getDocumentFromData(
                                                  createDailyNegaritRecordData(
                                                    id: currentUserUid,
                                                  ),
                                                  dailyNegaritRecordReference);

                                          var myNotesRecordReference =
                                              MyNotesRecord.createDoc(_model
                                                  .dailyNegaritCreated!
                                                  .reference);
                                          await myNotesRecordReference
                                              .set(createMyNotesRecordData(
                                            uid: currentUserUid,
                                            note: _model
                                                .noteNameTextController.text,
                                          ...
                                          _model.myNoteCreated =
                                              MyNotesRecord.getDocumentFromData(
                                                  createMyNotesRecordData(
                                                    uid: currentUserUid,
                                                    note: _model
                                                        .noteNameTextController
                                                        .text,
                                                    date: _model.datePicked1,
                                                    startTime:
                                                        _model.datePicked2,
