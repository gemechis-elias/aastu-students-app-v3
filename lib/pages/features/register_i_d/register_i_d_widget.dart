...
class _RegisterIDWidgetState extends State<RegisterIDWidget> {
  ...
  void initState() {
    ...
    _model.barCodeTextController ??=
        TextEditingController(text: _model.barcode);
                        ...
                        if (responsiveVisibility(
                          ...
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                16.0, 0.0, 16.0, 0.0),
                            child: Text(
                              'Click the scanner button and scan the bar code on your ID',
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
                                    fontFamily: 'Figtree',
                                ...
                                child: InkWell(
                                  ...
                                  onTap: () async {
                                    _model.resultBarcode =
                                        await actions.simpleBarCodeScanner(
                                      context,
                                    );
                                    if (_model.resultBarcode != 'null') {
                                      _model.barcode = _model.resultBarcode;
                                      safeSetState(() {});
                                      safeSetState(() {
                                      ...
                                      ScaffoldMessenger.of(context)
                                        ...
                                        SnackBar(
                                          content: Text(
                                            'Can\'t Scan your ID, Please try again.',
                                            style: TextStyle(
                                              color:
                        ...
                        Padding(
                          ...
                          child: FFButtonWidget(
                            onPressed: () async {
                              ...
                              if (_model.deptDropDownValue == null) {
                                return;
                              }
