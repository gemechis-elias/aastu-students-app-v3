...
class _EditUserProfileWidgetState extends State<EditUserProfileWidget> {
  ...
  void initState() {
    ...
    _model.departmentFocusNode1 ??= FocusNode();

    _model.departmentFocusNode2 ??= FocusNode();
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.idNumberTextController ??=
                                              TextEditingController(
                                        text:
                                            editUserProfileUsersRecord.idNumber,
                                      ),
                              ...
                              children: [
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.departmentTextController1 ??=
                                              TextEditingController(
                                        text: editUserProfileUsersRecord
                                            .department,
                                      ),
                                      focusNode: _model.departmentFocusNode1,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                      ...
                                      cursorColor:
                                          FlutterFlowTheme.of(context).primary,
                                      validator: _model
                                          .departmentTextController1Validator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
                              ...
                              children: [
                                Expanded(
                                  child: Padding(
                                    ...
                                    child: TextFormField(
                                      controller:
                                          _model.departmentTextController2 ??=
                                              TextEditingController(
                                        text: editUserProfileUsersRecord.batch,
                                      ),
                                      focusNode: _model.departmentFocusNode2,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Batch',
                                        labelStyle: FlutterFlowTheme.of(context)
                                      ...
                                      cursorColor:
                                          FlutterFlowTheme.of(context).primary,
                                      validator: _model
                                          .departmentTextController2Validator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            await currentUserReference!
                              ...
                              department: _model.departmentTextController1.text,
                              batch: _model.departmentTextController2.text,
                              photoBlurHash: _model.uploadedLocalFile.blurHash,
                            ));
                              ...
                              ...mapToFirestore(
                                {
                                  'activity_log': FieldValue.arrayUnion([
                                    'User Edited thier profile at ${getCurrentTimestamp.toString()}'
                                  ]),
                                },
                              ),
                            });
