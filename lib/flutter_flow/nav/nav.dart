...
GoRouter createRouter(AppStateNotifier appStateNotifier, [Widget? entryPage]) =>
    GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'grade_calulator',
          path: '/gradeCalulator',
          builder: (context, params) => GradeCalulatorWidget(),
        ),
        FFRoute(
          name: 'virtual_identity',
          path: '/virtualIdentity',
          builder: (context, params) => VirtualIdentityWidget(),
        ),
        FFRoute(
          name: 'registerID',
          path: '/register_id',
          builder: (context, params) => RegisterIDWidget(),
        ),
        FFRoute(
          name: 'QuizPage',
          path: '/QuizPage',
        ...
        FFRoute(
          ...
          path: '/ReligiousCommunity',
          builder: (context, params) => ReligiousCommunityWidget(),
        ),
        FFRoute(
          name: 'EngineersAssoc',
          path: '/EngineersAssoc',
          builder: (context, params) => EngineersAssocWidget(),
        ),
        FFRoute(
          name: 'StudentsHandBook',
          path: '/StudentsHandBook',
          builder: (context, params) => StudentsHandBookWidget(),
        ),
        FFRoute(
          name: 'DailyNegarit',
          path: '/DailyNegarit',
          builder: (context, params) => DailyNegaritWidget(),
        ),
        FFRoute(
          name: 'AASTU',
          path: '/aastu',
          builder: (context, params) => AastuWidget(),
        ),
        FFRoute(
          name: 'GradingSystem',
          path: '/gradingSystem',
          builder: (context, params) => GradingSystemWidget(),
        ),
        FFRoute(
          name: 'AboutUs',
          path: '/aboutUs',
        ...
        FFRoute(
          name: 'BookUpload',
          path: '/bookUpload',
          builder: (context, params) => BookUploadWidget(),
        )
          ...
          final child = appStateNotifier.loading
              ? isWeb
                  ...
                  : Container(
                      ...
                      child: Center(
                        child: Image.asset(
                          'assets/images/20241024_222818.png',
                          width: 150.0,
                          height: 150.0,
                          fit: BoxFit.cover,
                        ),
